...
possibleactions:
    ...
    (bascially the types of messages the client might send)
    These are NOT the same as transitions
    These are used by self::checkAction in game.action.php
    AND by this.checkAction in game.js
    to verify that the player action is allowed to perform the action
